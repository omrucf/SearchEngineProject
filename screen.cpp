...
// int screen::resultsScreen(vector<webpage *> output)
// {
//     int i;
...
//             cout << j + 1 << ". " << output[j]->getURL() << endl;
//             output[i]->calculateScore();
//         }

//         cout << "or type:\n(" << output.size() + 1 << ") New search\n(" << output.size() + 2 << ") Exit" << endl;

//         cin >> i;
//     } while (i > 0 && i < output.size() + 3);

//     int choice = webScreen(output, i);

//     return choice;
// }

// int screen::webScreen(vector<webpage *> output, int i)
// {
//     int choice;
